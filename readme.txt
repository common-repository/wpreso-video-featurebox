...
Tags: featured video content, video images, video thumbnails, video slider, featured content, jflow, youtube, google video, vimeo, blip.tv, viddler, metacafe, dailymotion, myspace
...
**For more information:** please visit the [WPreso Video FeatureBox documentation](http://www.wpreso.com/plugins/wpreso-video-featurebox/#documentation).
...
You can add the `<?php echo wpreso_videofeaturebox(); ?>` to your Theme. You can override the default settings set in the settings page. For more on this, please visit the [documentation](http://www.wpreso.com/plugins/wpreso-video-featurebox/#documentation).

= How do I add it in my posts/pages? =
You can add the shortcode [wpvfb] to your posts/pages. You can override the default settings set in the settings page. For more on this, please visit the [documentation](http://www.wpreso.com/plugins/wpreso-video-featurebox/#documentation).

= Where do I get support for this plugin? =
Well I can't believe that there are any questions left unanswered, after this FAQ and the [documentation](http://www.wpreso.com/plugins/wpreso-video-featurebox/#documentation), but should this really be the case, I ask you to post on the [WordPress.org support forums](http://wordpress.org/tags/wpreso-video-featurebox), and I will do my best, and when I have time, to answer your question. Please remember that this plugin is free and therefore support might at times be sparse as I might be working on other projects.
...
1. WPreso Video FeatureBox settings page
2. WPreso Video FeatureBox example.
2. WPreso Video FeatureBox example.
